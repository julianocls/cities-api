...
public class DistanceService {
     ...
     * @return
     */
    public Optional<Double> distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        return Optional.of(doCalculation(location1[0], location1[1], location2[0], location2[1], unit));
    }
     ...
     * @return
     */
    public Optional<Double> distanceByCubeInMeters(Long city1, Long city2) {
        ...
        return Optional.of(cityRepository.distanceByCube(p1.getX(), p1.getY(), p2.getX(), p2.getY()));
    }
